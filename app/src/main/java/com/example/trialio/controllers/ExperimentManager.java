    ...
    private Experiment extractExperiment(DocumentSnapshot document) {
        ...
        if (ExperimentTypeUtility.isBinomial(tm.get("type").toString())) {
            for (Map trial : (ArrayList<Map>) tm.get("trials")) {
                ...
                experiment.getTrialManager().addTrial(new BinomialTrial((String) trial.get("experimenterID"), new Location((double) location.get("latitude"), (double) location.get("longitude")), ((com.google.firebase.Timestamp) trial.get("date")).toDate(), String.valueOf((boolean) trial.get("isSuccess"))));
            }
        } else if (ExperimentTypeUtility.isCount(tm.get("type").toString())) {
            for (Map trial : (ArrayList<Map>) tm.get("trials")) {
                Map location = (Map) trial.get("location");
                experiment.getTrialManager().addTrial(new CountTrial((String) trial.get("experimenterID"), new Location((double) location.get("latitude"), (double) location.get("longitude")), ((com.google.firebase.Timestamp) trial.get("date")).toDate(), String.valueOf(trial.get("count"))));
            }
        } else if (ExperimentTypeUtility.isNonNegative(tm.get("type").toString())) {
            for (Map trial : (ArrayList<Map>) tm.get("trials")) {
                Map location = (Map) trial.get("location");
                experiment.getTrialManager().addTrial(new NonNegativeTrial((String) trial.get("experimenterID"), new Location((double) location.get("latitude"), (double) location.get("longitude")), ((com.google.firebase.Timestamp) trial.get("date")).toDate(), ((java.lang.Long) trial.get("nonNegCount")).intValue(), String.valueOf( ((java.lang.Long) trial.get("nonNegCount")).intValue())));
            }
